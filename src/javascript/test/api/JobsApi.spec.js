...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesTimApi.JobsApi();
  });
  ...
  describe('JobsApi', function() {
    describe('createProvisioningJob', function() {
      it('should call createProvisioningJob successfully', function(done) {
        //uncomment below and update the code to test createProvisioningJob
        //instance.createProvisioningJob(function(error) {
