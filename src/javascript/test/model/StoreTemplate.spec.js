...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SalesTimApi.StoreTemplate();
  });
  ...
  describe('StoreTemplate', function() {
    it('should create an instance of StoreTemplate', function() {
      // uncomment below and update the code to test StoreTemplate
      //var instane = new SalesTimApi.StoreTemplate();
      //expect(instance).to.be.a(SalesTimApi.StoreTemplate);
    });
