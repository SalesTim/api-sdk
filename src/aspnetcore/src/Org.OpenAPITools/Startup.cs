            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0.0", new Info
                    {
                        Version = "1.0.0",
                        Title = "SalesTim API",
                        Description = "SalesTim API (ASP.NET Core 2.2)",
                        Contact = new Contact()
                        {
                    ...
                    c.DocumentFilter<BasePathFilter>("/v1.0");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/1.0.0/openapi.json", "SalesTim API");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "SalesTim API Original");
                });
