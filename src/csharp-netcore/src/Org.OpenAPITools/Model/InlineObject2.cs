...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject2 :  IEquatable<InlineObject2>, IValidatableObject
    {
        ...
        /// <param name="enabled">The plugin status, enabled or disabled.</param>
        public InlineObject2(string name = default(string), string description = default(string), bool enabled = default(bool))
        {
            this.Name = name;
